...
## Overview
This project implements an OpenEnv-compatible environment for evaluating API workflow orchestration.

Given a workflow generated by an agent, the system executes it and assigns a score based on:
- API correctness
- Execution order
- Parameter accuracy
- Efficiency
